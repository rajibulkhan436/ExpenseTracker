package com.rajibul.expensetracker.presentation.home_screen

import androidx.compose.ui.graphics.Color
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.rajibul.expensetracker.R
import com.rajibul.expensetracker.common.Constants
import com.rajibul.expensetracker.data.local.entity.TransactionDto
import com.rajibul.expensetracker.domain.model.Transaction
import com.rajibul.expensetracker.domain.usecase.GetDateUseCase
import com.rajibul.expensetracker.domain.usecase.GetFormattedDateUseCase
import com.rajibul.expensetracker.domain.usecase.read_database.GetAccountUseCase
import com.rajibul.expensetracker.domain.usecase.read_database.GetAccountsUseCase
import com.rajibul.expensetracker.domain.usecase.read_database.GetAllTransactionUseCase
import com.rajibul.expensetracker.domain.usecase.read_database.GetCurrentDayExpTransactionUseCase
import com.rajibul.expensetracker.domain.usecase.read_database.GetDailyTransactionUseCase
import com.rajibul.expensetracker.domain.usecase.read_database.GetMonthlyExpTransactionUse
import com.rajibul.expensetracker.domain.usecase.read_database.GetWeeklyExpTransactionUseCase
import com.rajibul.expensetracker.domain.usecase.read_datastore.GetCurrencyUseCase
import com.rajibul.expensetracker.domain.usecase.read_datastore.GetExpenseLimitUseCase
import com.rajibul.expensetracker.domain.usecase.read_datastore.GetLimitDurationUseCase
import com.rajibul.expensetracker.domain.usecase.read_datastore.GetLimitKeyUseCase
import com.rajibul.expensetracker.domain.usecase.write_database.InsertAccountsUseCase
import com.rajibul.expensetracker.domain.usecase.write_database.InsertNewTransactionUseCase
import com.rajibul.expensetracker.presentation.ui.theme.businessBg
import com.rajibul.expensetracker.presentation.ui.theme.clothBg
import com.rajibul.expensetracker.presentation.ui.theme.pocketMoneyBg
import com.rajibul.expensetracker.presentation.ui.theme.food_drink
import com.rajibul.expensetracker.presentation.ui.theme.gadgetBg
import com.rajibul.expensetracker.presentation.ui.theme.giftBg
import com.rajibul.expensetracker.presentation.ui.theme.groceryBg
import com.rajibul.expensetracker.presentation.ui.theme.healthBg
import com.rajibul.expensetracker.presentation.ui.theme.homeBg
import com.rajibul.expensetracker.presentation.ui.theme.leisureBg
import com.rajibul.expensetracker.presentation.ui.theme.miscBg
import com.rajibul.expensetracker.presentation.ui.theme.investmentBg
import com.rajibul.expensetracker.presentation.ui.theme.schBg
import com.rajibul.expensetracker.presentation.ui.theme.salaryBg
import com.rajibul.expensetracker.presentation.ui.theme.billsBg
import com.rajibul.expensetracker.presentation.ui.theme.taxiBg
import com.rajibul.expensetracker.presentation.ui.theme.travelBg
import com.rajibul.expensetracker.presentation.ui.theme.vehicleBg
...
enum class Account(val title: String, val iconRes: Int, val color: Color) {
    ...
    BANK("Bank", R.drawable.bank, billsBg),
...
enum class Category(
    ...
    STUDY("Study", R.drawable.study, schBg),
    GROCERY("Grocery", R.drawable.grocery, groceryBg, Color.Black),
    POCKETMONEY("Pocket Money", R.drawable.pocketmoney, pocketMoneyBg, Color.Black),
    ...
    BILLS("Bills", R.drawable.bills, billsBg),
    INVESTMENT("Investment", R.drawable.investment, investmentBg, Color.Black),
    SALARY("Salary", R.drawable.salary, salaryBg, Color.Black),
